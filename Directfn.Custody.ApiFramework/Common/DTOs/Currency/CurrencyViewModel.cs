...
namespace Directfn.Custody.ApiFramework.Common.DTOs.Currency
{
    public class CurrencyViewModel
    {
        ...
        public DateTime RF08_CREATED_DATE { get; set; }
        public int RF08_MODIFIED_BY { get; set; }
        public DateTime RF08_MODIFIED_DATE { get; set; }
        public int RF08_STATUS { get; set; }
        public int RF08_ID { get; set; }
        public string RF08_IP { get; set; }
        ...
        public int RF08_IS_POSTED { get; set; }
        public bool isPosted { get; set; }

        public string IsPosted_Desc { get; set; }
        public List<CurrencyViewModel> lstCurrencies { get; set; }
    }
}
